...
OBJECTS = backtrack.o 8-queens.o permutations.o subsets.o queue.o war.o \
	...
	tree-demo.o matrix.o main.o
BINARIES = 8-queens main permutations subsets war sorting bfs-demo \
	...
	bipartite kruskal matrix tree-demo
